...
export const seedRooms = [
  { name: "Chambre Mouassine", slug: "mouassine", description: "Chambre double élégante avec zellige fait main et vue sur le patio. Idéale pour un couple.", capacity: 2, basePrice: 850, sortOrder: 1 },
  { name: "Chambre Saadienne", slug: "saadienne", description: "Une chambre lumineuse aux tons terracotta, ornée de stuc traditionnel.", capacity: 2, basePrice: 900, sortOrder: 2 },
  { name: "Chambre Bahia", slug: "bahia", description: "Chambre raffinée inspirée des palais de la Médina, calme et fraîche.", capacity: 2, basePrice: 950, sortOrder: 3 },
  { name: "Chambre Koutoubia", slug: "koutoubia", description: "Chambre confortable pouvant accueillir une troisième personne, parfaite pour les petites familles.", capacity: 3, basePrice: 1100, sortOrder: 4 },
  { name: "Suite Medina", slug: "medina", description: "Suite spacieuse avec coin salon marocain, pensée pour les familles.", capacity: 4, basePrice: 1450, sortOrder: 5 },
  { name: "Suite Patio", slug: "patio", description: "Grande suite ouverte sur le patio central, lumière douce toute la journée.", capacity: 3, basePrice: 1300, sortOrder: 6 },
  { name: "Suite Terrasse", slug: "terrasse", description: "La plus belle suite du riad, avec accès privilégié à la terrasse panoramique.", capacity: 4, basePrice: 1600, sortOrder: 7 },
];
