...
export function WhatsAppFloat({ locale }: { locale: Locale }) {
  return (
    <a
      ...
      aria-label="WhatsApp"
      // On mobile sit above the ~64px bottom nav; on lg+ revert to corner position
      className="fixed bottom-20 right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-soft transition hover:scale-105 lg:bottom-5 lg:right-5"
    >
