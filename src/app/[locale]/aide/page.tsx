...
export async function generateMetadata({
  ...
  const fr = locale !== "en";
  return {
    title: fr ? "FAQ & Aide — Mbn Demo Riad" : "FAQ & Help — Mbn Demo Riad",
    description: fr
      ? "Questions fréquentes sur votre séjour au Mbn Demo Riad à Marrakech : arrivée, petit-déjeuner, annulation et plus."
      : "Frequently asked questions about your stay at Mbn Demo Riad in Marrakech: check-in, breakfast, cancellation and more.",
...
const faqFr: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Oui, les enfants sont les bienvenus au Mbn Demo Riad ! Merci de préciser l'âge et le nombre d'enfants dans votre demande afin que nous puissions préparer l'espace au mieux.",
  },
  {
...
const faqEn: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Yes, children are very welcome at Mbn Demo Riad! Please mention the age and number of children in your request so we can prepare the space accordingly.",
  },
  {
