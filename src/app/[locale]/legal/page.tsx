...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const fr = locale !== "en";
  return {
    title: fr ? "Informations légales — Riad Dar Kader" : "Legal Information — Riad Dar Kader",
    robots: { index: false },
  };
}
  ...
  return (
    <main className="container-page max-w-3xl py-16 lg:py-24">
      ...
      <p className="mt-3 text-sm leading-relaxed text-muted">
        {fr
          ? "Retrouvez ci-dessous l'ensemble des documents légaux du Riad Dar Kader. Chaque document est consultable sur sa propre page."
          : "Find below all the legal documents of Riad Dar Kader. Each document can be consulted on its own page."}
      </p>
