...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const fr = locale !== "en";
  return {
    title: fr ? "Conditions générales d'utilisation — Mbn Demo Riad" : "Terms & Conditions — Mbn Demo Riad",
    robots: { index: false },
  };
}
...
export default async function TermsPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const intro = fr
    ? "Les présentes conditions générales définissent les règles d'utilisation du site du Mbn Demo Riad et les relations entre le riad et ses visiteurs. En naviguant sur ce site, en créant un compte ou en effectuant une demande de réservation, vous reconnaissez avoir lu et accepté ces conditions."
    : "These terms and conditions set out the rules for using the Mbn Demo Riad website and the relationship between the riad and its visitors. By browsing this site, creating an account or submitting a booking request, you acknowledge that you have read and accepted these terms.";

  const sections: LegalSection[] = fr
    ? [
        { heading: "Objet et acceptation", blocks: [
          { type: "p", text: "Ce site a pour objet de présenter le Mbn Demo Riad, ses chambres et ses expériences, et de permettre aux voyageurs d'adresser des demandes de réservation en direct. L'utilisation du site implique l'acceptation pleine et entière des présentes conditions. Si vous n'acceptez pas ces conditions, nous vous invitons à ne pas utiliser le site." },
        ] },
    ...
    : [
        { heading: "Purpose and acceptance", blocks: [
          { type: "p", text: "The purpose of this site is to present Mbn Demo Riad, its rooms and experiences, and to allow travellers to submit booking requests directly. Using the site implies full acceptance of these terms. If you do not accept them, we ask that you do not use the site." },
        ] },
        ...
        { heading: "Intellectual property", blocks: [
          { type: "p", text: "All elements of the site (text, photographs, illustrations, logo, design and code) are protected by intellectual property law and remain the exclusive property of Mbn Demo Riad or its partners. Any reproduction, representation or use, in whole or in part, without prior written permission, is prohibited." },
        ] },
