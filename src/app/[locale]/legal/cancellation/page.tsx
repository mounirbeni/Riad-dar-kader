...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const fr = locale !== "en";
  return {
    title: fr ? "Annulation & remboursement — Riad Dar Kader" : "Cancellation & Refund Policy — Riad Dar Kader",
    robots: { index: false },
  };
}
  ...
  const sections: LegalSection[] = fr
    ? [
        { heading: "Comment annuler", blocks: [
          { type: "p", text: "Pour annuler ou modifier une réservation, contactez le riad le plus tôt possible par e-mail à contact@riaddarkader.com ou via WhatsApp. La date de réception de votre demande fait foi pour le calcul des éventuels frais." },
        ] },
    ...
    : [
        { heading: "How to cancel", blocks: [
          { type: "p", text: "To cancel or change a booking, contact the riad as early as possible by email at contact@riaddarkader.com or via WhatsApp. The date your request is received is what counts for calculating any fees." },
        ] },
