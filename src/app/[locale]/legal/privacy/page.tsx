...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const fr = locale !== "en";
  return {
    title: fr ? "Politique de confidentialité — Riad Dar Kader" : "Privacy Policy — Riad Dar Kader",
    robots: { index: false },
  };
}
    ...
    ? [
        {
          ...
          blocks: [
            { type: "p", text: "Le responsable du traitement des données est le Riad Dar Kader, situé dans la Médina, près du Musée Mouassine, Marrakech, Maroc. Pour toute question relative à vos données, vous pouvez nous contacter à contact@riaddarkader.com." },
          ],
        },
        {
        ...
        },
        {
          ...
          blocks: [
            ...
            { type: "p", text: "Pour exercer ces droits, écrivez à contact@riaddarkader.com. Nous répondons sous 30 jours. Vous pouvez également introduire une réclamation auprès de l'autorité de protection des données compétente." },
          ],
        },
        {
          heading: "Sécurité",
    ...
    : [
        {
          ...
          blocks: [
            { type: "p", text: "The data controller is Riad Dar Kader, located in the Medina, near Musée Mouassine, Marrakech, Morocco. For any question regarding your data, you can contact us at contact@riaddarkader.com." },
          ],
        },
        {
        ...
        },
        {
          ...
          blocks: [
            ...
            { type: "p", text: "To exercise these rights, write to contact@riaddarkader.com. We respond within 30 days. You may also lodge a complaint with the competent data protection authority." },
          ],
        },
        {
          heading: "Security",
