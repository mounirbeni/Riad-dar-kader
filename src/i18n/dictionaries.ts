    ...
    home: {
      ...
      testimonials: [
        ...
        },
        {
          name: "James K.",
          origin: "London, UK",
          text: "Notre séjour ici a été le point fort du voyage. Le petit-déjeuner, la terrasse au coucher du soleil, la chaleur de l'équipe — tout simplement inoubliable.",
        },
        {
          name: "Amira B.",
    ...
    home: {
      ...
      testimonials: [
        ...
        },
        {
          name: "James K.",
          origin: "London, UK",
          text: "Staying here was the highlight of our trip. The breakfast, the rooftop at sunset, the warmth of the team — simply unforgettable.",
        },
        {
          name: "Amira B.",
